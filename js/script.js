const ApiKey = "48739a85420c4e389904511e029b16c1";
                ...
                info.onclick = (event) => {
                    ...
                    fetch(url, fetchHeader)
                        ...
                        .then(data => {
                            dataModal = `
                            <tr>
                                <td class="center-align"><img src="${data.crestUrl}"  alt="" width="100px" ></td>
                            </tr>
                            <br>
                            <table class="responsive-table striped">
                                ...
                                <tr>
                                    <td>Team Name</td>
                                    <td>${(data.shortName == null) ? '-' : data.shortName}</td>
                                </tr>
                                <tr>
                                    <td>Founded In</td>
                                ...
                                <tr>
                                    <td>Club Color</td>
                                    <td>${(data.clubColors == null) ? '-' : data.clubColors}</td>
                                </tr>
                                </tbody>
                            </table>`
